...
A Statistician/Probabilist and Clojure engineer. In the last few years, focused on organizing [Scicloj](https://scicloj.github.io/), an open-source group building Clojure's data science stack. 
...
tibble::tribble(
  ...
  #
  "Open-source developer and organizer", "funded by Clojurists Together", "Feb-Apr 2024",
  c("During this quarter, my regular activity at Scicloj was selected to supported by the Clojurists Together organization."),
  #
  ...
  c("Took part in the startup from early stages; recruited and mentored team members.",
    "Worked on data problems in diverse fields including urban spatio-temporal modeling, real-estate pricing, NLP, and recommendation systems.",
    "Used diverse technologies (Clojure, Java, R, Python, Tensorflow Probability, Stan, PyMC, SQL, etc.).",
...
tibble::tribble(
  ...
  "Co-organizer", "Scicloj", "2019-persent",
  c("Co-maintaining open-source projects, mainly Kindly, Clay, Notespace, ClojisR, and the Scicloj website.",
    "Running dev groups, study groups, and workshops; mentoring newcomers.",
    "Organizing Jointprob, a study community for Bayesian statistics and probabilistic modeling."),
...
$*$ Clojure, R, Python, C, Java; Tensorflow Probability, Stan; PyMC; spaCy; Clojurescript, Javascript; Linux shell; DVC; Docker; PostgreSQL, etc.
